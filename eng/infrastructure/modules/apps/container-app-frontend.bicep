...
@description('The API base URL for the frontend to connect to.')
param apiBaseUrl string

module containerApp '../container-app.bicep' = {
  name: '${uniqueString(deployment().name, location)}-container-app-frontend'
  params: {
    location: location
    ...
    containerImageName: 'container-workshop/shop'
    targetPort: 8080
