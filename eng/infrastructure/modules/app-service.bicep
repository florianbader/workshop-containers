...
@description('The suffix for the app service name (e.g., api, shop).')
param suffix string
...
// Generate name following schema: app-{app}-{env}-{location}-{suffix}
var name = 'app-${appIdentifier}-${environment}-${locationAbbr}-${suffix}'
